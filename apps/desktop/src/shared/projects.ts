...
export const PINE_SESSIONS_DIRECTORY = `${PINE_METADATA_DIRECTORY}/sessions` as const;
export const PINE_SKILLS_DIRECTORY = `${PINE_METADATA_DIRECTORY}/skills` as const;
